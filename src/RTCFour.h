...
/*
	Extending the Arduino RTCZero library to apply to SAM D5x/E5x Family devices eg. SAMD51 or Cortext-M4.
...
private:
	/* SAM D5x/E5x Family */
	void configure_1k_OSC(void);
	void select_rtc_clock(void);
